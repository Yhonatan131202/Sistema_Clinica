							...
							echo '<tr>
									...
									<td>
										...
										<div class="btn-group">
											...
											<button class="btn btn-danger EliminarPaciente" Pid="'.$value["id"].'" onclick="return confirm(\'¿Estás seguro de eliminar?\')" imgP="'.$value["foto"].'"><i class="fa fa-times"></i> Borrar</button>
