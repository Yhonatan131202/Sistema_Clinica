				...
				<div class="row">
					...
					<div class="col-md-6 col-xs-12">
						...
						if($resultado["foto"] == ""){
							...
							echo '<img src="./Vistas/img/defecto.png" width="200px;">';

						}else{

							echo '<img src="./'.$resultado["foto"].'" width="200px;">';
	...
	public function ActualizarPerfilAdminC(){
		...
		if(isset($_POST["Aid"])){
			...
			if($resultado == true){
				...
				window.location = "./perfil-A/'.$resultado["id"].'";
				</script>';
