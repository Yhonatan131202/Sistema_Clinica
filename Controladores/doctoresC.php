					...
					<h3>Cambiar Consultorio</h3>
						...
						<div class="col-md-6 col-xs-12">
							...
							if($resultado["foto"] == ""){
								...
								echo '<img src="./Vistas/img/defecto.png" class="img-responsive" width="200px">';

							}else{

								echo '<img src="./'.$resultado["foto"].'" class="img-responsive" width="200px">';
	...
	public function ActualizarPerfilDoctorC(){
		...
		if(isset($_POST["Did"])){
			...
			if($resultado == true){
				...
				window.location = "./perfil-D/'.$resultado["id"].'";
				</script>';
